...
if svm_train:
    ...
    filename = '/home/xigong/trt_pose/tasks/hand_pose/svmmodel_new.sav'
...
while(True):#nis
    ...
    preprocessdata.print_label(image, preprocessdata.prev_queue, gesture_type)#ges_clf
    """
